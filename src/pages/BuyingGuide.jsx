...
import buyingGuideImage from '../../public/images/buying1.jpg';
import buying2 from '../../public/images/buying2.jpg';
        ...
        <div className="bg-white text-black font-sans min-h-screen">
            ...
            <div className="relative bg-black text-white py-24 md:py-32 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-8">
                    ...
                    <div className="w-48 h-1.5 bg-primary-blue mb-8 rounded-full mx-auto"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="text-center mb-20 max-w-3xl mx-auto">
                    <h2 className="text-3xl font-bold mb-6 italic underline decoration-primary-blue decoration-4 underline-offset-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
                    {[
                        ...
                        },
                        {
                            ...
                            icon: <Target className="text-primary-blue" size={32} />,
                        ...
                        },
                        {
                            ...
                            icon: <Droplet className="text-primary-blue" size={32} />,
                        ...
                        },
                        {
                            ...
                            icon: <Zap className="text-primary-blue" size={32} />,
                        ...
                        <div key={idx} className="bg-gray-50 p-8 rounded-3xl border border-gray-100 hover:shadow-xl transition-shadow group">
                            <div className="bg-white p-4 rounded-2xl shadow-sm inline-block mb-6 group-hover:bg-primary-blue group-hover:text-white transition-colors">
                                {card.icon}
                            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
                    ...
                    <div className="space-y-10">
                        <h2 className="text-4xl font-bold italic underline decoration-primary-blue decoration-2">Key Considerations</h2>
                        ...
                        <div className="space-y-8">
                            {[
                                ...
                                <div key={idx} className="flex gap-6">
                                    <div className="text-4xl font-black text-primary-blue/20 italic">{idx + 1}</div>
                                    <div>
                ...
                <div className="bg-slate-900 rounded-3xl p-10 md:p-16 text-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-primary-blue/10 rounded-full -mr-32 -mt-32 blur-3xl"></div>
                    <div className="relative z-10">
                        <h2 className="text-4xl font-bold mb-12 italic text-center underline decoration-primary-blue decoration-2 underline-offset-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                            {[
                                ...
                                <div key={idx} className="text-center group">
                                    <div className="w-16 h-16 bg-primary-blue rounded-full flex items-center justify-center text-2xl font-black mx-auto mb-6 group-hover:scale-110 transition-transform">
                                        {idx + 1}
                                    </div>
                        ...
                        <div className="mt-16 text-center">
                            <a href="/shop" className="inline-flex items-center gap-3 bg-primary-blue hover:bg-white hover:text-primary-blue text-black font-bold px-10 py-4 rounded-xl transition-all uppercase tracking-widest text-sm">
