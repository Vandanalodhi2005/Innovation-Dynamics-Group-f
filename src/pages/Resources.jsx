    ...
    return (
        <div className="bg-white text-black font-sans min-h-screen">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                            ...
                            <nav className="space-y-1">
                                {[
                                    ...
                                    <a
                                        key={item.id}
                                        href={`#${item.id}`}
                                        className="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:bg-blue-50 hover:text-primary-blue text-gray-600 font-medium group"
                                    >
                    ...
                    <div className="lg:col-span-3 space-y-24">
                        ...
                        <section id="basics" className="scroll-mt-24 space-y-10">
                            <h2 className="text-4xl font-bold flex items-center gap-4 italic underline decoration-primary-blue decoration-4">
                                <span className="bg-primary-blue text-white w-12 h-12 rounded-xl flex items-center justify-center text-2xl not-italic font-black shadow-lg">1</span>
                                Printer Basics
                            </h2>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { type: "Inkjet Printers", desc: "Ideal for vibrant colors, photos, graphics, and everyday family use.", icon: <Droplet className="text-primary-blue" /> },
                                    { type: "Laser Printers", desc: "Best for fast, high-volume, black-and-white or color office printing.", icon: <Zap className="text-primary-blue" /> },
                                    { type: "Home Printers", desc: "Compact, budget-friendly printers designed for low to moderate print needs.", icon: <Printer className="text-primary-blue" /> },
                                    { type: "Office Printers", desc: "Efficient, durable printers built for multiple users and frequent printing.", icon: <Target className="text-primary-blue" /> }
                                ].map((item, idx) => (
                        ...
                        <section id="ink-toner" className="scroll-mt-24 space-y-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                ...
                                <div className="p-8 bg-blue-50 rounded-3xl border border-blue-100 space-y-4">
                                    <h4 className="font-bold text-xl flex items-center gap-2 italic"><ShieldCheck className="text-primary-blue" /> High-Yield (XL)</h4>
                                    <p className="text-xs font-bold text-primary-blue uppercase tracking-widest">Max Efficiency</p>
                                    <ul className="space-y-2 text-sm text-gray-600 font-medium italic">
                        ...
                        <section id="choose" className="scroll-mt-24 space-y-10">
                            <h2 className="text-4xl font-bold flex items-center gap-4 italic underline decoration-primary-blue decoration-4">
                                <span className="bg-primary-blue text-white w-12 h-12 rounded-xl flex items-center justify-center text-2xl not-italic font-black shadow-lg">3</span>
                                Choose by Your Needs
                            </h2>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                                <div className="bg-black text-white p-8 rounded-3xl space-y-6 relative overflow-hidden">
                                    <div className="absolute top-0 right-0 w-24 h-24 bg-primary-blue/10 rounded-full -mr-12 -mt-12 blur-2xl"></div>
                                    <h3 className="text-2xl font-bold italic underline decoration-primary-blue decoration-4">Home Users</h3>
                                ...
                                <div className="bg-gray-50 p-8 rounded-3xl space-y-6 border border-gray-100">
                                    <h3 className="text-2xl font-bold italic underline decoration-primary-blue decoration-4 text-gray-900">Office Users</h3>
                                ...
                                <div className="bg-gray-50 p-8 rounded-3xl space-y-6 border border-gray-100">
                                    <h3 className="text-2xl font-bold italic underline decoration-primary-blue decoration-4 text-gray-900">Students</h3>
                                    <ul className="space-y-3 text-gray-600 font-medium italic">
                                ...
                                <div className="bg-black text-white p-8 rounded-3xl space-y-6 relative overflow-hidden">
                                    <div className="absolute top-0 right-0 w-24 h-24 bg-primary-blue/10 rounded-full -mr-12 -mt-12 blur-2xl"></div>
                                    <h3 className="text-2xl font-bold italic underline decoration-primary-blue decoration-4">Small Businesses</h3>
                                    <ul className="space-y-3 text-gray-400 font-medium italic">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                                {[
                                    ...
                                    <div key={idx} className="flex gap-6 items-start">
                                        <div className="text-primary-blue mt-1">{feature.icon}</div>
                                        <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <section id="paper" className="scroll-mt-24 space-y-6 bg-blue-50/50 p-8 rounded-3xl border border-blue-100">
                                ...
                                <ul className="space-y-4 text-sm font-medium italic text-gray-700">
                                    <li><span className="text-primary-blue font-bold">Photo Paper:</span> Glossy, matte, and professional-grade.</li>
                                    <li><span className="text-primary-blue font-bold">Everyday documents:</span> Multipurpose office paper.</li>
                                    <li><span className="text-primary-blue font-bold">Specialty Media:</span> Label sheets and cards.</li>
                                    <li><span className="text-primary-blue font-bold">Essential Gear:</span> USB cables, maintenance kits, roller kits.</li>
                                </ul>
                            </section>
                            ...
                            <section id="cost" className="scroll-mt-24 space-y-6 bg-gray-900 text-white p-8 rounded-3xl">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <ul className="space-y-2 text-sm text-primary-blue font-bold">
                        ...
                        <section id="compat" className="scroll-mt-24 bg-gray-50 p-10 rounded-3xl border border-gray-100">
                            ...
                            <p className="mt-8 text-center text-primary-blue font-bold italic text-lg leading-relaxed">
                        ...
                        <section id="faq" className="scroll-mt-24 space-y-10">
                            <h2 className="text-3xl font-bold italic underline decoration-primary-blue decoration-4">8. Common Printing Questions</h2>
                            <div className="space-y-6">
                                {[
                                    ...
                                    <div key={idx} className="bg-white border-l-4 border-primary-blue p-6 shadow-sm rounded-r-2xl">
                        ...
                        <section id="links" className="scroll-mt-24 pt-12 border-t border-gray-100">
                            ...
                            <div className="flex flex-wrap gap-3">
                                {[
                                    ...
                                    <a key={idx} href={link.url} className="px-5 py-2.5 bg-gray-50 hover:bg-primary-blue hover:text-white rounded-full text-xs font-bold uppercase transition-all border border-gray-200">
                                        {link.label}
                                    </a>
                                ))}
                            </div>
                        ...
                        <section id="contact" className="bg-black text-white p-12 rounded-[3rem] relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-primary-blue/20 rounded-full -mr-32 -mt-32 blur-3xl"></div>
                            <div className="relative z-10 text-center max-w-2xl mx-auto">
                                <Mail className="mx-auto mb-6 text-primary-blue" size={48} />
                                <h2 className="text-3xl font-bold mb-6 italic underline decoration-primary-blue decoration-4">10. Need More Help?</h2>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left max-w-xl mx-auto">
                                    <div className="flex items-center gap-4">
                                        <div className="bg-white/10 p-3 rounded-xl border border-white/10"><Phone className="text-primary-blue" size={20} /></div>
                                        <p className="font-bold">+1 (651) 815-4630</p>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="bg-white/10 p-3 rounded-xl border border-white/10"><Mail className="text-primary-blue" size={20} /></div>
            ...
            <div className="py-20 bg-gray-50 text-center border-t border-gray-100">
                <ShieldCheck className="mx-auto mb-6 text-primary-blue opacity-40" size={64} />
