...
const Navbar = () => {
    ...
    const getLinkClasses = (path) => {
        ...
        const isHome = path === '/' && (currentPath === '/' || currentPath === '/index.html');
        const isMatch = currentPath === path || currentPath === `${path}.html`;
        ...
        <nav className="bg-[#024ad8] text-white shadow-lg border-b border-white/10 sticky top-0 z-50 font-sans backdrop-blur-md">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="hidden lg:flex space-x-8 items-center">
                        ...
                        <a href="/about.html" className={getLinkClasses('/about')}>About Us</a>
                        ...
                        >
                            ...
                            <div className={`absolute left-1/2 -translate-x-1/2 mt-5 w-72 bg-white text-black rounded-sm shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-gray-100 transition-all duration-500 z-50 overflow-hidden ${isShopDropdownOpen ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible translate-y-2'}`}>
                                <div className="p-4 grid grid-cols-1 gap-1">
                                    <a href="/shop.html" onClick={closeAllMenus} className="group/item flex items-center justify-between px-4 py-4 mb-2 bg-[#024ad8] text-white hover:bg-black transition-all">
                                    ...
                                    <a href="/home-printers.html" onClick={closeAllMenus} className="group/item flex items-center justify-between px-4 py-3 rounded-sm hover:bg-[#024ad8]/5 transition-all">
                                        <div className="flex items-center gap-4">
                                    ...
                                    <a href="/office-printers.html" onClick={closeAllMenus} className="group/item flex items-center justify-between px-4 py-3 rounded-sm hover:bg-[#024ad8]/5 transition-all">
                                        <div className="flex items-center gap-4">
                                            <div className="w-8 h-8 bg-gray-50 rounded-full flex items-center justify-center text-gray-400 group-hover/item:text-[#024ad8] group-hover/item:bg-white transition-all">
                                                <Users size={16} />
                                            </div>
                                    ...
                                    <a href="/laser-printers.html" onClick={closeAllMenus} className="group/item flex items-center justify-between px-4 py-3 rounded-sm hover:bg-[#024ad8]/5 transition-all">
                                        <div className="flex items-center gap-4">
                                            <div className="w-8 h-8 bg-gray-50 rounded-full flex items-center justify-center text-gray-400 group-hover/item:text-[#024ad8] group-hover/item:bg-white transition-all">
                                                <Zap size={16} />
                                            </div>
                                    ...
                                    <a href="/inkjet-printers.html" onClick={closeAllMenus} className="group/item flex items-center justify-between px-4 py-3 rounded-sm hover:bg-[#024ad8]/5 transition-all">
                                        <div className="flex items-center gap-4">
                                            <div className="w-8 h-8 bg-gray-50 rounded-full flex items-center justify-center text-gray-400 group-hover/item:text-[#024ad8] group-hover/item:bg-white transition-all">
                                                <Droplets size={16} />
                                            </div>
                                    ...
                                    <a href="/ink-toner.html" onClick={closeAllMenus} className="mt-4 group/item flex items-center gap-4 px-4 py-4 bg-gray-900 text-white hover:bg-[#024ad8] transition-all">
                        ...
                        <a href="/faqs.html" className={getLinkClasses('/faqs')}>FAQs</a>
                        <a href="/contact.html" className={getLinkClasses('/contact')}>Contact Us</a>
                    </div>
                    ...
                    <div className="hidden lg:flex items-center space-x-6">
                        ...
                        <div className="relative group/user">
                            {isAuthenticated ? (
                                ...
                                <a href="/login.html" className="flex items-center gap-2 group/login" aria-label="Login">
                            ...
                            {isAuthenticated && (
                                <div className="absolute right-0 mt-4 w-60 bg-white text-black rounded-sm shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-gray-200 opacity-0 invisible group-hover/user:opacity-100 group-hover/user:visible transition-all duration-500 translate-y-2 group-hover/user:translate-y-0 z-50 overflow-hidden">
                                    ...
                                    <div className="p-2 grid grid-cols-1 gap-1">
                                        ...
                                        <a href="/profile.html" className="flex items-center gap-4 px-4 py-3 rounded-sm hover:bg-gray-100 transition-colors">
                                            <User size={16} className="text-[#024ad8]" />
                                            <span className="text-[10px] font-bold uppercase tracking-widest">Profile</span>
                                        </a>
                                        <a href="/track-order.html" className="flex items-center gap-4 px-4 py-3 rounded-sm hover:bg-gray-100 transition-colors">
                        ...
                        <a href="/cart.html" aria-label={`Shopping Cart, ${cartCount} items`} className="text-white hover:text-white/90 transition-colors duration-300 relative group">
                    ...
                    <div className="lg:hidden flex items-center gap-2">
                        <a href="/cart.html" aria-label={`Shopping Cart, ${cartCount} items`} className="text-white hover:text-white/90 transition-colors duration-300 relative p-3 flex items-center justify-center">
            ...
            <div className={`lg:hidden transition-all duration-300 ease-in-out bg-[#024ad8] overflow-hidden ${isMenuOpen ? 'max-h-screen opacity-100 shadow-xl' : 'max-h-0 opacity-0'}`}>
                <div className="px-4 pt-2 pb-6 space-y-2 border-t border-white/20">
                    ...
                    <a href="/about.html" onClick={toggleMenu} className={getMobileLinkClasses('/about')}>About Us</a>
                    ...
                    <div>
                        ...
                        <div className={`pl-6 space-y-1 transition-all duration-300 overflow-hidden ${isShopDropdownOpen ? 'max-h-[500px]' : 'max-h-0'}`}>
                            <a href="/shop.html" onClick={closeAllMenus} className="block px-3 py-3 rounded-md text-sm font-black uppercase tracking-widest text-white bg-white/10 mb-2">Shop All Products</a>
                            <a href="/home-printers.html" onClick={closeAllMenus} className="block px-3 py-2 rounded-md text-sm text-white/80 hover:text-white hover:bg-white/10 transition-colors">Home Printers</a>
                            <a href="/office-printers.html" onClick={closeAllMenus} className="block px-3 py-2 rounded-md text-sm text-white/80 hover:text-white hover:bg-white/10 transition-colors">Office Printers</a>
                            <a href="/laser-printers.html" onClick={closeAllMenus} className="block px-3 py-2 rounded-md text-sm text-white/80 hover:text-white hover:bg-white/10 transition-colors">Laser Printers</a>
                            <a href="/inkjet-printers.html" onClick={closeAllMenus} className="block px-3 py-2 rounded-md text-sm text-white/80 hover:text-white hover:bg-white/10 transition-colors">Inkjet Printers</a>
                            <a href="/ink-toner.html" onClick={closeAllMenus} className="block px-3 py-2 rounded-md text-sm text-white/80 hover:text-white hover:bg-white/10 transition-colors">Ink & Toner</a>
                        </div>
                    </div>

                    <a href="/faqs.html" onClick={toggleMenu} className={getMobileLinkClasses('/faqs')}>FAQs</a>
                    <a href="/contact.html" onClick={toggleMenu} className={getMobileLinkClasses('/contact')}>Contact Us</a>
                    ...
                    <div className="border-t border-white/20 pt-4 mt-4 flex items-center gap-4 px-3 flex-wrap">
                        {isAuthenticated ? (
                            <>
                                ...
                                <div className="w-full flex items-center justify-between bg-white/10 p-3 rounded-lg border border-white/20 mb-2">
                                    <a href="/profile.html" onClick={toggleMenu} className="flex items-center gap-3">
                            ...
                            <a href="/login.html" onClick={toggleMenu} className="flex items-center gap-3 bg-white/10 p-3 rounded-lg border border-white/20 mb-2 w-full hover:bg-white/20 transition-colors">
                        ...
                        <a href="/track-order.html" onClick={toggleMenu} className="flex items-center gap-2 text-white hover:text-white/80 transition-colors w-full">
                            <Truck size={20} />
