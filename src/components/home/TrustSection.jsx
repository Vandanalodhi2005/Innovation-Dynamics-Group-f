            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-stretch">
                    ...
                    <div className="flex flex-col justify-center">
                        <div className="space-y-10">
                            <div className="space-y-4">
                                ...
                                <h2 className="text-4xl font-black text-black tracking-tighter uppercase leading-tight">
                            ...
                            <ul className="grid grid-cols-1 gap-4">
                                {[
                                    ...
                                    <li key={i} className="flex items-center gap-4 group">
                                        ...
                                        <span className="text-gray-700 font-bold uppercase tracking-wide text-xs">{feature}</span>
                                    </li>
                                ))}
                            </ul>

                            <div className="pt-6 border-t border-gray-100 italic text-sm text-gray-400 font-medium">
                    ...
                    <div className="relative">
                        ...
                        <div className="h-full bg-black p-10 md:p-14 rounded-sm text-white shadow-2xl relative z-10 overflow-hidden flex flex-col justify-between">
                            {/* High-Contrast Brand Watermark Background */}
                            <div className="absolute top-0 right-0 p-8 opacity-40">
                                <img src="/logo/hp-partner.png" alt="" className="w-56" />
                            </div>

                            <div className="space-y-8 relative z-20">
                                <div className="space-y-3">
                                    <h3 className="text-2xl font-black uppercase tracking-tight">Built on Trust and <br/> Transparency</h3>
                                ...
                                <div className="bg-[#024ad8]/10 border border-[#024ad8]/20 p-6 rounded-sm">
                                    <p className="text-xs font-bold leading-relaxed text-blue-200 uppercase tracking-widest">
                                ...
                                <div className="space-y-6">
                                    <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em]">Customers can expect:</p>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {[
                                            { icon: <Search size={16} />, text: "Honest Info" },
                                            { icon: <Activity size={16} />, text: "Clear Policies" },
                                            { icon: <CreditCard size={16} />, text: "Reliable Service" },
                                            { icon: <Lock size={16} />, text: "Secure Shopping" }
                                        ].map((item, i) => (
                            ...
                            <div className="mt-12 pt-10 border-t border-white/5 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <ShieldCheck className="text-[#024ad8]" size={24} />
                                    <span className="text-[9px] font-black text-gray-500 uppercase tracking-[0.3em]">Verified Secure</span>
                                </div>
                                <img src="/logo/hp-partner.png" alt="HP Partner" className="h-8 w-auto" />
                            </div>
                        </div>
