            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                    <div className="max-w-2xl text-center lg:text-left">
                        <span className="text-[11px] font-black uppercase tracking-[0.4em] text-[#024ad8] mb-6 block">Ready to Begin</span>
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tighter leading-tight mb-6">
                            ...
                            <span className="text-[#024ad8]">with Confidence</span>
                        </h2>
                        <p className="text-gray-400 text-base sm:text-lg font-medium leading-relaxed mb-10 max-w-xl mx-auto lg:mx-0">
                    ...
                    <div className="hidden lg:block relative">
                         ...
                         <div className="w-80 h-80 bg-gray-900 rounded-sm -rotate-12 flex items-center justify-center border border-gray-800 relative z-10">
                             <div className="text-center p-8">
                                 <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">Verification Check</p>
