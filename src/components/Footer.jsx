        ...
        <footer className="bg-black text-white pt-16 pb-8 border-t-4 border-primary-orange font-sans">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed">
                            Shop high-quality printers designed to deliver sharp results, smooth connectivity, and dependable performance for any environment.
                        </p>
                    </div>

                    {/* Quick Links */}
                    <div>
                        <h3 className="text-lg font-bold mb-6 text-primary-orange uppercase tracking-wider">Quick Links</h3>
                        <ul className="space-y-3 text-sm text-gray-300">
                            ...
                            <li><a href="/order-tracking" className="hover:text-primary-orange transition-colors">Order Tracking</a></li>
                            <li><a href="/blog" className="hover:text-primary-orange transition-colors">BLOG</a></li>
                            <li><a href="/faqs" className="hover:text-primary-orange transition-colors">FAQs</a></li>
                            <li><a href="/contact" className="hover:text-primary-orange transition-colors">Contact Us</a></li>
                        </ul>
                    </div>

                    {/* Important Links */}
                    <div>
                        <h3 className="text-lg font-bold mb-6 text-primary-orange uppercase tracking-wider">Important Links</h3>
                        <ul className="space-y-3 text-sm text-gray-300">
                    ...
                    {/* Quick Contacts */}
                    <div>
                        <h3 className="text-lg font-bold mb-6 text-primary-orange uppercase tracking-wider">Quick Contacts</h3>
                ...
                <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} Innovation Dynamics Group. All rights reserved.</p>
